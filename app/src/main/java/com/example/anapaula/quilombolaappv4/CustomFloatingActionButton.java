...
public class CustomFloatingActionButton extends View{
    ...
    public CustomFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CustomFloatingActionButton);
        mColor = a.getColor(R.styleable.CustomFloatingActionButton_color, Color.WHITE);
        mButtonPaint.setStyle(Paint.Style.FILL);
        mButtonPaint.setColor(mColor);
        float radius, dx, dy;
        radius = a.getFloat(R.styleable.CustomFloatingActionButton_shadowRadius, 10.0f);
        dx = a.getFloat(R.styleable.CustomFloatingActionButton_shadowDx, 0.0f);
        dy = a.getFloat(R.styleable.CustomFloatingActionButton_shadowDy, 3.5f);
        int color = a.getInteger(R.styleable.CustomFloatingActionButton_shadowColor, Color.argb(100, 0, 0, 0));
        mButtonPaint.setShadowLayer(radius, dx, dy, color);

        Drawable drawable = a.getDrawable(R.styleable.CustomFloatingActionButton_drawable);
        if (null != drawable) {

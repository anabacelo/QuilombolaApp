 ...
 */
//6 implementar a interface implements IOnBackPressed
public class Nav2 extends Fragment implements IOnBackPressed {
...
//    private HashMap<String, List<Integer>> listHash;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(CheckInternetConnection.simpleServerCheck()){
            mWebView.loadUrl("http://app-quilombola.epizy.com/hubquilombosdeportoalegre.html");
            Toast.makeText(GlobalApplication.getAppContext(), "Versão web carregada!", Toast.LENGTH_LONG).show();
        }
        else {
            mWebView.loadUrl("file:///android_asset/www/hubquilombosdeportoalegre.html");
    ...
    //7 coloca o metodo da implementacao
    @Override
    ...
    //mata metodos onViewCreated initializeData
